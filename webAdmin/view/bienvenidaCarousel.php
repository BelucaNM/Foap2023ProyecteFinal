...
<section id="gruposProducto" class="section">
        ...
        <div class="wrapper">
          <ul class="carousel">
            <li class="card">
                <div class="img"><img src="../img/imagenCamarasANA200px.jpg" alt="ImagenCamarasANA" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenCamarasDIG200px.jpg" alt="ImagenCamarasDIG" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenObjetivosMAN200px.jpg" alt="ImagenObjetivosMAN" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenObjetivosAUT200px.jpg" alt="ImagenObjetivosAUT" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenFiltros200px.jpg" alt="ImagenFiltros" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenSoportes200px.jpg" alt="ImagenSoportes" class="card-img"></div>
            ...
            <li  class="card">
                <div class="img"><img src="../img/imagenAdaptadores200px.jpg" alt="ImagenAdaptadores" class="card-img"></div>
            ...
            <li class="card">
                <div class="img"><img src="../img/imagenBaterias200px.jpg" alt="ImagenBaterias" class="card-img"></div>
            ...
            <li class="card">
                    <div class="img"><img src="../img/imagenCables200px.jpg" alt="ImagenCables" class="card-img"></div>
            ...
            <li class="card">
                    <div class="img"><img src="../img/imagenBolsas200px.jpg" alt="ImagenBolsas" class="card-img"></div>
            ...
            <li class="card">
                    <div class="img"><img src="../img/imagenAccesorios200px.jpg" alt="ImagenAccesorios" class="card-img"></div>
